...
(function($) {
	...
	$.fn.prettyPhoto = function(settings) {
		...
		$.prettyPhoto.open = function(gallery_images,gallery_titles,gallery_descriptions) {
			...
			$pp_pic_holder.fadeIn(function(){
				...
				// Inject the proper content
                            ...
                            //*   alert(_getFileType(images[setPosition]));
		...
		*/
		...
		_showContent = function(toInject){
			$('.pp_loaderIcon').hide();
			...
			$pp_pic_holder.animate({
				...
				if(settings.showTitle && hasTitle){
					...
					$ppt.fadeIn(settings.animationSpeed); //poznámka aha, přepnul jsem Ti češinu
				};
				...
				settings.changepicturecallback();
                                ...
                                if (toInject) $pp_pic_holder.find('#pp_full_res')[0].innerHTML = toInject;
			});
